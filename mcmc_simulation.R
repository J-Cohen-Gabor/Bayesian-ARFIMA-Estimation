...
if (!require(extraDistr))install.packages('MASS',lib = "~/R_lib",repos="https://cran.csiro.au/")
if (!require(truncnorm))install.packages('spam',lib = "~/R_lib",repos="https://cran.csiro.au/")
